...
/*GetHPCResourceUnauthorized Authorization error
...
/*GetHPCResourceForbidden Authorization error
...
func (o *GetHPCResourceNotFound) WithPayload(payload *models.MissingResponse) *GetHPCResourceNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get h p c resource not found response
func (o *GetHPCResourceNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
