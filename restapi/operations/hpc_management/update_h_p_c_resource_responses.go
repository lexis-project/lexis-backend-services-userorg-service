...
/*UpdateHPCResourceUnauthorized Authorization error
...
/*UpdateHPCResourceForbidden Authorization error
...
func (o *UpdateHPCResourceNotFound) WithPayload(payload *models.MissingResponse) *UpdateHPCResourceNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update h p c resource not found response
func (o *UpdateHPCResourceNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
