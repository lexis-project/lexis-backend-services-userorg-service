...
func (o *AddRoleOK) WithPayload(payload *models.RoleAdded) *AddRoleOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add role o k response
func (o *AddRoleOK) SetPayload(payload *models.RoleAdded) {
	o.Payload = payload
}
...
/*AddRoleUnauthorized Authorization error
...
/*AddRoleForbidden Authorization error
...
/*AddRoleNotFound user/org/prj not found
...
func (o *AddRoleNotFound) WithPayload(payload *models.MissingResponse) *AddRoleNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add role not found response
func (o *AddRoleNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
