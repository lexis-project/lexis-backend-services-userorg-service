...
func (o *AddRoleParams) bindOrganizationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AddRoleParams) validateOrganizationID(formats strfmt.Registry) error {
...
func (o *AddRoleParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddRoleParams) validateProjectID(formats strfmt.Registry) error {
...
func (o *AddRoleParams) bindProjectShortName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddRoleParams) bindRole(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddRoleParams) bindUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddRoleParams) validateUserID(formats strfmt.Registry) error {
