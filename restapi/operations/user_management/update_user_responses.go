...
/*UpdateUserUnauthorized Authorization error
...
/*UpdateUserForbidden Authorization error
...
/*UpdateUserNotFound user with userId not found
...
func (o *UpdateUserNotFound) WithPayload(payload *models.MissingResponse) *UpdateUserNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update user not found response
func (o *UpdateUserNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
