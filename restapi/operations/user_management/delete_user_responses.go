...
/*DeleteUserUnauthorized Authorization error
...
/*DeleteUserForbidden Authorization error
...
/*DeleteUserNotFound user with userId not found
...
func (o *DeleteUserNotFound) WithPayload(payload *models.MissingResponse) *DeleteUserNotFound {
	o.Payload = payload
	return o
}
