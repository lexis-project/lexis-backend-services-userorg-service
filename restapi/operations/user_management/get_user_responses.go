...
/*GetUserUnauthorized Authorization error
...
/*GetUserForbidden Authorization error
...
/*GetUserNotFound user with userId not found
...
func (o *GetUserNotFound) WithPayload(payload *models.MissingResponse) *GetUserNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user not found response
func (o *GetUserNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
