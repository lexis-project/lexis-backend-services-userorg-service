...
func (o *CreateUserCreated) WithPayload(payload *models.CreatedResponse) *CreateUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create user created response
func (o *CreateUserCreated) SetPayload(payload *models.CreatedResponse) {
	o.Payload = payload
}
...
/*CreateUserUnauthorized Authorization error
...
/*CreateUserForbidden Authorization error
...
func (o *CreateUserConflict) WithPayload(payload *models.ConflictResponse) *CreateUserConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create user conflict response
func (o *CreateUserConflict) SetPayload(payload *models.ConflictResponse) {
	o.Payload = payload
}
