...
/*DeleteOrganizationUnauthorized Authorization error
...
/*DeleteOrganizationForbidden Authorization error
...
func (o *DeleteOrganizationNotFound) WithPayload(payload *models.MissingResponse) *DeleteOrganizationNotFound {
	o.Payload = payload
	return o
}
