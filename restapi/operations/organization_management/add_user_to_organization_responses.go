...
func (o *AddUserToOrganizationNotFound) WithPayload(payload *models.MissingResponse) *AddUserToOrganizationNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add user to organization not found response
func (o *AddUserToOrganizationNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
