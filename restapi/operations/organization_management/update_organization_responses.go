...
/*UpdateOrganizationUnauthorized Authorization error
...
/*UpdateOrganizationForbidden Authorization error
...
func (o *UpdateOrganizationNotFound) WithPayload(payload *models.MissingResponse) *UpdateOrganizationNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update organization not found response
func (o *UpdateOrganizationNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
