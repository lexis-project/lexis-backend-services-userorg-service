...
func (o *GetOrganizationParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetOrganizationParams) validateID(formats strfmt.Registry) error {
