...
func (o *ListOrganizationsParams) bindScope(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewListOrganizationsParams()
		return nil
	}
...
func (o *ListOrganizationsParams) validateScope(formats strfmt.Registry) error {
