...
// AddUserToOrganizationParams contains all the bound params for the add user to organization operation
// typically these are obtained from a http.Request
//
// swagger:parameters addUserToOrganization
...
//
// To ensure default values, the struct must have been initialized with NewAddUserToOrganizationParams() beforehand.
func (o *AddUserToOrganizationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AddUserToOrganizationParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AddUserToOrganizationParams) validateID(formats strfmt.Registry) error {
...
func (o *AddUserToOrganizationParams) bindUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddUserToOrganizationParams) validateUserID(formats strfmt.Registry) error {
