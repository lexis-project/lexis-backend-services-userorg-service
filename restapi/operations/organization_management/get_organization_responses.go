...
/*GetOrganizationUnauthorized Authorization error
...
/*GetOrganizationForbidden Authorization error
...
func (o *GetOrganizationNotFound) WithPayload(payload *models.MissingResponse) *GetOrganizationNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get organization not found response
func (o *GetOrganizationNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
