...
/*GetProjectUnauthorized Authorization error
...
/*GetProjectForbidden Authorization error
...
func (o *GetProjectNotFound) WithPayload(payload *models.MissingResponse) *GetProjectNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get project not found response
func (o *GetProjectNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
