...
func (o *CreateProjectCreated) WithPayload(payload *models.CreatedResponse) *CreateProjectCreated {
	o.Payload = payload
	return o
}
...
/*CreateProjectUnauthorized Authorization error
...
/*CreateProjectForbidden Authorization error
...
func (o *CreateProjectConflict) WithPayload(payload *models.ConflictResponse) *CreateProjectConflict {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create project conflict response
func (o *CreateProjectConflict) SetPayload(payload *models.ConflictResponse) {
	o.Payload = payload
}
