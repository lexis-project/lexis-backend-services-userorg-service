...
/*AddUserToProjectNotFound project or user not found
...
func (o *AddUserToProjectNotFound) WithPayload(payload *models.MissingResponse) *AddUserToProjectNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add user to project not found response
func (o *AddUserToProjectNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
