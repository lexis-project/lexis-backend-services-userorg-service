...
/*UpdateProjectUnauthorized Authorization error
...
/*UpdateProjectForbidden Authorization error
...
func (o *UpdateProjectNotFound) WithPayload(payload *models.MissingResponse) *UpdateProjectNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update project not found response
func (o *UpdateProjectNotFound) SetPayload(payload *models.MissingResponse) {
	o.Payload = payload
}
