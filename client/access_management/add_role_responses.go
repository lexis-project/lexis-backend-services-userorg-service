...
func (o *AddRoleOK) GetPayload() *models.RoleAdded {
	return o.Payload
}
...
/*AddRoleNotFound handles this case with default header values.
...
func (o *AddRoleNotFound) Error() string {
	return fmt.Sprintf("[POST /authz/{userID}/add/{role}][%d] addRoleNotFound  %+v", 404, o.Payload)
}

func (o *AddRoleNotFound) GetPayload() *models.MissingResponse {
	return o.Payload
}
