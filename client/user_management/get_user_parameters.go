...
func (o *GetUserParams) WithID(id strfmt.UUID) *GetUserParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get user params
func (o *GetUserParams) SetID(id strfmt.UUID) {
	o.ID = id
}

// WithPermissions adds the permissions to the get user params
func (o *GetUserParams) WithPermissions(permissions *bool) *GetUserParams {
	o.SetPermissions(permissions)
	return o
}

// SetPermissions adds the permissions to the get user params
func (o *GetUserParams) SetPermissions(permissions *bool) {
