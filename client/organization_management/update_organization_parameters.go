...
func (o *UpdateOrganizationParams) WithOrganization(organization *models.Organization) *UpdateOrganizationParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the update organization params
func (o *UpdateOrganizationParams) SetOrganization(organization *models.Organization) {
