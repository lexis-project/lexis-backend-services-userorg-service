...
// WithID adds the id to the get organization params
func (o *GetOrganizationParams) WithID(id strfmt.UUID) *GetOrganizationParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get organization params
func (o *GetOrganizationParams) SetID(id strfmt.UUID) {
	o.ID = id
}
